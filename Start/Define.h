...
#define FRAME_STATE_CASE_MACRO(A, B, C, D, E) case A: return {B, C, D, E, dwNow};
	...
	switch (eID)
	{
		...
		FRAME_STATE_CASE_MACRO(FSI_MONSTER_WARRIOR_RIGHT_ATTACKREADY,		0, 19, 19, 100)
		FRAME_STATE_CASE_MACRO(FSI_MONSTER_WARRIOR_RIGHT_ATTACKEND,			0, 6, 20, 100)
		FRAME_STATE_CASE_MACRO(FSI_MONSTER_WARRIOR_RIGHT_ATTACK,			0, 4, 21, 100)
		...
		FRAME_STATE_CASE_MACRO(FSI_MONSTER_WARRIOR_LEFT_ATTACKREADY,		0, 19, 25, 100)
		FRAME_STATE_CASE_MACRO(FSI_MONSTER_WARRIOR_LEFT_ATTACKEND,			0, 6, 26, 100)
		FRAME_STATE_CASE_MACRO(FSI_MONSTER_WARRIOR_LEFT_ATTACK,				0, 4, 27, 100)
