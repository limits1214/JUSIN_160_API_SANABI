...
enum CHANNELID {
	...
	SOUND_BGM_FIREBIRD_LOOP,
	SOUND_SFX_MACHINEGUN_SHOOT,
	SOUND_SFX_BOMBING_START,
	SOUND_SFX_BOMBING_EXPLOSION,
	SOUND_SFX_BODYSLAPALERT,
	SOUND_SFX_BODYSLAP,
	SOUND_SFX_CLUSTERAIM_WARNING,
	SOUND_SFX_CLUSTERSHOOT,
	SOUND_SFX_CLUSTERBOMBLETEXPLOSION,
	SOUND_SFX_FLTBOMB_EXPLOSION,
	SOUND_SFX_GATE_OPEN,
	SOUND_SFX_GATE_CLOSE,
	SOUND_SFX_BOSS_DESTROY1,
	SOUND_SFX_BOSS_DESTROY2,
	SOUND_SFX_BOSS_DESTROY3,
	SOUND_SFX_SURVEYDRONE_PHOTO,
	SOUND_SFX_ENE_EXPLOSION,
	SOUND_SFX_ENE_WARRIOR_EXPLOSION,
	SOUND_SFX_BULLET_EXPLOSION,
	SOUND_SFX_WARRIOR_SLASH,
	SOUND_SFX_DEFENDER_SHOOT,
	SOUND_SFX_SPAWN_WARNING,
	SOUND_SFX_PODSPAWN,
	...
	SOUND_SFX_JUMP,
	SOUND_SFX_WALLCLIMBUP,
	SOUND_SFX_WALL_STICK,
	SOUND_SFX_CEILINGMOVE,

	SOUND_SFX_UICLICK,
	SOUND_SFX_UISELECT,

	SOUND_SFX_LOGO_INTRO,

	//SOUND_BGM_ENDINGMARI,
	MAXCHANNEL
};
...
STR_MACRO2(FKI_ENDING_MARI_BG, "FKI_ENDING_MARI_BG");
STR_MACRO2(FKI_ENDING_MARI, "FKI_ENDING_MARI");
STR_MACRO2(FKI_SNB_LOGO_KOR, "FKI_SNB_LOGO_KOR");
STR_MACRO2(FKI_LOGO, "LOGO");
STR_MACRO2(FKI_MOUSE_POINTER, "MOUSE_POINTER");
...
inline const TCHAR* FrameKeyId_To_Text2(FRAME_KEY_ID eID)
{
	switch (eID)
	{
	case FKI_ENDING_MARI_BG:
		return STR_FKI_ENDING_MARI_BG;
	case FKI_ENDING_MARI:
		return STR_FKI_ENDING_MARI;
	case FKI_SNB_LOGO_KOR:
		return STR_FKI_SNB_LOGO_KOR;
	case FKI_LOGO:
		return STR_FKI_LOGO;
	case FKI_MOUSE_POINTER:
		return STR_FKI_MOUSE_POINTER;
	case FKI_GATE_SHEET:
...
enum FRAME_STATE_ID
{
	...
	FSI_NEW_L_ARM_CEILING_STICK_MOVE_END,
		FSI_NEW_R_SNB_DAMAGED,
		FSI_NEW_L_SNB_DAMAGED,
	FSI_NEW_R_SNB_DASH,
	FSI_NEW_L_SNB_DASH,
		FSI_NEW_R_SNB_EXCWINDING,
		FSI_NEW_L_SNB_EXCWINDING,
	FSI_NEW_R_SNB_EXCHOLDBACK,
	FSI_NEW_R_ARM_EXCHOLDBACK,
	FSI_NEW_L_SNB_EXCHOLDBACK,
	FSI_NEW_L_ARM_EXCHOLDBACK,
		FSI_NEW_R_SNB_EXCDASH,
		FSI_NEW_R_ARM_EXCDASH,
		FSI_NEW_L_SNB_EXCDASH,
		FSI_NEW_L_ARM_EXCDASH,
...
#define FRAME_STATE_CASE_MACRO(A, B, C, D, E) case A: return {B, C, D, E, dwNow};
	...
	switch (eID)
	{
		FRAME_STATE_CASE_MACRO(FSI_ENDING_MARI_BG, 0, 10, 0, 200)
		FRAME_STATE_CASE_MACRO(FSI_ENDING_MARI, 0, 10, 0, 200)
		FRAME_STATE_CASE_MACRO(FSI_SNB_LOGO_KOR, 0, 0, 0, 100)
		FRAME_STATE_CASE_MACRO(FSI_LOGO_WONDERPOTION,	0, 8, 0, 200)
		FRAME_STATE_CASE_MACRO(FSI_LOGO_NEOWIZ,			0, 0, 1, 100)

		FRAME_STATE_CASE_MACRO(FSI_MOUSE_POINTER, 0, 0, 0, 100)
		...
		*/
		...
		FRAME_STATE_CASE_MACRO(FSI_GRAB_BOTTOM, 0, 11, 3, 100)
			...
			FRAME_STATE_CASE_MACRO(FSI_NEW_L_ARM_LAND2RUN,	0, 11, 35, 100)
				...
				FRAME_STATE_CASE_MACRO(FSI_NEW_R_SNB_DAMAGED, 0, 4, 82, 100)
				FRAME_STATE_CASE_MACRO(FSI_NEW_L_SNB_DAMAGED, 0, 4, 83, 100)

				FRAME_STATE_CASE_MACRO(FSI_NEW_R_SNB_DASH, 0, 3, 84, 100)
				FRAME_STATE_CASE_MACRO(FSI_NEW_L_SNB_DASH, 0, 3, 85, 100)

				FRAME_STATE_CASE_MACRO(FSI_NEW_R_SNB_EXCWINDING, 0, 1, 86, 100)
				FRAME_STATE_CASE_MACRO(FSI_NEW_L_SNB_EXCWINDING, 0, 1, 87, 100)

				FRAME_STATE_CASE_MACRO(FSI_NEW_R_SNB_EXCHOLDBACK, 0, 7, 88, 100)
				FRAME_STATE_CASE_MACRO(FSI_NEW_R_ARM_EXCHOLDBACK, 0, 7, 89, 100)
				FRAME_STATE_CASE_MACRO(FSI_NEW_L_SNB_EXCHOLDBACK, 0, 7, 90, 100)
				FRAME_STATE_CASE_MACRO(FSI_NEW_L_ARM_EXCHOLDBACK, 0, 7, 91, 100)

				FRAME_STATE_CASE_MACRO(FSI_NEW_R_SNB_EXCDASH, 0, 7, 92, 50)
				FRAME_STATE_CASE_MACRO(FSI_NEW_R_ARM_EXCDASH, 0, 7, 93, 50)
				FRAME_STATE_CASE_MACRO(FSI_NEW_L_SNB_EXCDASH, 0, 7, 94, 50)
				FRAME_STATE_CASE_MACRO(FSI_NEW_L_ARM_EXCDASH, 0, 7, 95, 50)
