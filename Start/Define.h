	...
	FSI_EXPLOSION_BIG,
		...
		*/
		...
		FRAME_STATE_CASE_MACRO(FSI_MONSTER_WARRIOR_LEFT_COMAEND,			0, 5, 15, 100)
			...
			FRAME_STATE_CASE_MACRO(FSI_MONSTER_DUMMYROBOT_LEFT_IDLE,		0, 7, 0, 100)
			FRAME_STATE_CASE_MACRO(FSI_MONSTER_DUMMYROBOT_RIGHT_RUNNING,	0, 7, 1, 100)
			FRAME_STATE_CASE_MACRO(FSI_MONSTER_DUMMYROBOT_LEFT_RUNNING,		0, 7, 2, 100)
			FRAME_STATE_CASE_MACRO(FSI_MONSTER_DUMMYROBOT_RESPAWN,			0, 6, 3, 100)
			FRAME_STATE_CASE_MACRO(FSI_MONSTER_DUMMYROBOT_EXCHOLDBACK,		0, 7, 4, 100)
			FRAME_STATE_CASE_MACRO(FSI_MONSTER_DUMMYROBOT_EXCSTART,			0, 2, 5, 100)
			FRAME_STATE_CASE_MACRO(FSI_MONSTER_DUMMYROBOT_DEAD,				0, 12, 6, 100)
