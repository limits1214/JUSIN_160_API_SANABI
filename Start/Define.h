...
enum FRAME_STATE_ID
{
	...
	// 불새 날래
	FSI_BOSS_FIREBIRD_WING_NORMAL_DOWNLOOP,
	FSI_BOSS_FIREBIRD_WING_NORMAL_NEULOOP,
	FSI_BOSS_FIREBIRD_WING_NORMAL_UPLOOP,
	// 불새 부서진몸
	FSI_BOSS_FIREBIRD_BODY_BROKEN_IDLE,
	// 불새 부서진날개
	FSI_BOSS_FIREBIRD_WING_BROKEN_DOWNLOOP,
	FSI_BOSS_FIREBIRD_WING_BROKEN_NEULOOP,
	FSI_BOSS_FIREBIRD_WING_BROKEN_UPLOOP,
...
#define FRAME_STATE_CASE_MACRO(A, B, C, D, E) case A: return {B, C, D, E, dwNow};
	...
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_NORMAL_NEULOOP,	0, 0, 0, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_NORMAL_UPLOOP,	0, 3, 1, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_NORMAL_DOWNLOOP,	0, 3, 2, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_BROKEN_NEULOOP,	0, 0, 3, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_BROKEN_UPLOOP,	0, 3, 4, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_BROKEN_DOWNLOOP,	0, 3, 5, 100)
