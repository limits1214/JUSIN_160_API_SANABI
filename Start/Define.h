...
#define FRAME_STATE_CASE_MACRO(A, B, C, D, E) case A: return {B, C, D, E, dwNow};
	...
	switch (eID)
	{
			...
			FRAME_STATE_CASE_MACRO(FSI_TUTO_ANI_JUMP,			0, 5, 1, 100)
		...
		FRAME_STATE_CASE_MACRO(FSI_GRAB_BOTTOM, 0, 11, 3, 100)
			...
			FRAME_STATE_CASE_MACRO(FSI_NEW_L_ARM_LAND2RUN,	0, 11, 35, 100)
				...
				FRAME_STATE_CASE_MACRO(FSI_NEW_R_SNB_WALL_CLIMBDOWN,	0, 9, 48, 100)
				FRAME_STATE_CASE_MACRO(FSI_NEW_R_ARM_WALL_CLIMBDOWN,	0, 9, 49, 100)
				FRAME_STATE_CASE_MACRO(FSI_NEW_L_SNB_WALL_CLIMBDOWN,	0, 9, 50, 100)
				FRAME_STATE_CASE_MACRO(FSI_NEW_L_ARM_WALL_CLIMBDOWN,	0, 9, 51, 100)
