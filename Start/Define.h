...
inline const TCHAR* TileEditMode_To_Text(TILE_EDIT_MODE eID)
{
	switch (eID)
	{
		...
		STR_CASE_MACRO(TEM_IMG)
		STR_CASE_MACRO(TEM_GRID_TOGGLE)
		STR_CASE_MACRO(TEM_TRIGGER)
...
//inline FRAME_KEY_ID Tile_Id_ToFrameKeyId(TILE_ID eID)
//{
//	//switch (eID)
//	//{
//	//case TILE_TEST_1:
...
//inline TILE_ID FrameKey_To_Tile_Id(TCHAR* szText)
//{
//	if (!lstrcmp(szText, _T("TILE_TEST")))
//	{
//		return TILE_TEST_1;
//	}
//}
