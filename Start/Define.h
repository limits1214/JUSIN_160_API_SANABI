...
enum FRAME_STATE_ID
{
	...
	// 불새 날래
	FSI_BOSS_FIREBIRD_WING_NORMAL_DOWNLOOP1,
	FSI_BOSS_FIREBIRD_WING_NORMAL_NEULOOP,
	FSI_BOSS_FIREBIRD_WING_NORMAL_UPLOOP1,
	// 불새 부서진몸
	FSI_BOSS_FIREBIRD_BODY_BROKEN_IDLE,
	// 불새 부서진날개
	FSI_BOSS_FIREBIRD_WING_BROKEN_DOWNLOOP1,
	FSI_BOSS_FIREBIRD_WING_BROKEN_NEULOOP,
	FSI_BOSS_FIREBIRD_WING_BROKEN_UPLOOP1,
...
#define FRAME_STATE_CASE_MACRO(A, B, C, D, E) case A: return {B, C, D, E, dwNow};
	...
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_BOMBER_CLOSING,		0, 0, 0, 0) //TODO
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_BOMBER_OPENING,		0, 0, 0, 0) //TODO
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_GUN_SHOOTEND,			0, 26, 0, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_GUN_SHOOTLOOP,			0, 3, 0, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_GUN_SHOOTREADYLOOP,	0, 3, 0, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_BODY_NORMAL_IDLE,		0, 3, 0, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_NORMAL_DOWNLOOP1, 0, 0, 1, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_NORMAL_NEULOOP,	0, 3, 0, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_NORMAL_UPLOOP1,	0, 3, 0, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_BODY_BROKEN_IDLE,		0, 3, 1, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_BROKEN_DOWNLOOP1, 0, 3, 1, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_BROKEN_NEULOOP,	0, 3, 1, 100)
	FRAME_STATE_CASE_MACRO(FSI_BOSS_FIREBIRD_WING_BROKEN_UPLOOP1,	0, 3, 1, 100)
