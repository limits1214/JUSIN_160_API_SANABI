...
#include "CTimeMgr.h"
#include "CBmpMgr.h"
CObjMonsterFloatingBombSprite::CObjMonsterFloatingBombSprite()
{
	Set_DbgName(_T("CObjMonsterFloatingBombSprite"));
}
...
void CObjMonsterFloatingBombSprite::Initialize()
{
...
int CObjMonsterFloatingBombSprite::Update()
{
	if (m_bDead)
		return OBJ_DEAD;
...
void CObjMonsterFloatingBombSprite::Late_Update()
{
	Motion_Change();
}

void CObjMonsterFloatingBombSprite::Render(HDC hDC)
{
...
void CObjMonsterFloatingBombSprite::Release()
{
}
void CObjMonsterFloatingBombSprite::Motion_Change()
{
